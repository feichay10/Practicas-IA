...
% Crear una ventana que salga con el mensaje: ¡Bienvenido a la aplicacion de recomendacion de canciones!
create_window :- 
    new(D, dialog('¡Bienvenido a la aplicacion de recomendacion de canciones!')),
    send(D, append, new(T, text_item('¿Cómo te sientes hoy?'))),
    ...
    send(D2, append, button('Aceptar', message(D2, return, T2?selection))),
    send(D2, append, button('Cancelar', message(D2, return, @nil))),
